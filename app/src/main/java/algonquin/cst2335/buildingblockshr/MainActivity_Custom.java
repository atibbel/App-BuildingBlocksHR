        ...
        navigationView.setNavigationItemSelectedListener((item)->{
            switch(item.getItemId()) {
                ...
                case R.id.popout_dental:
                    Intent nextPage1_2 = new Intent(MainActivity_Custom.this, DentalActivity.class);
                    startActivity(nextPage1_2);
                    break;

                case R.id.popout_other_benefits:
                    Intent nextPage1_3 = new Intent(MainActivity_Custom.this, OtherBenefitsActivity.class);
                    startActivity(nextPage1_3);
                    break;

                case R.id.popout_perks:
                    Intent nextPage1_4 = new Intent(MainActivity_Custom.this, PerksActivity.class);
                ...
                case R.id.popout_timeoff:
                    Intent nextPage2_2 = new Intent(MainActivity_Custom.this, ScheduleTimeOffActivity.class);
                    startActivity(nextPage2_2);
                    break;

//                case R.id.popout_remaining_days:
//                    Intent nextPage2_3 = new Intent(MainActivity_Custom.this, VacationDaysRemainingActivity.class);
...
//                    break;
                ...
                case R.id.popout_other:
                    Intent nextPage3_3 = new Intent(MainActivity_Custom.this, OthersActivity.class);
