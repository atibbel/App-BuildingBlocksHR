...
//                    Intent nextPage = new Intent(PrivacyPolicyActivity.this, PolicyActivity.class);
//                    startActivity(nextPage);
//                    break;
//
//                case R.id.popout_benefits:
//                    Intent nextPage1 = new Intent(PrivacyPolicyActivity.this, BenefitsActivity_Custom.class);
//                    startActivity(nextPage1);
//                    break;
//
//                case R.id.popout_vacation:
//                    Intent nextPage2 = new Intent(PrivacyPolicyActivity.this, VacationActivity.class);
